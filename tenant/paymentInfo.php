...
<div class="content-header">
  <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 text-dark">Payment Info</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
         ...
         <div class="card">
             ...
             <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                     ...
                     <tbody>
                    <?php 
                    $query_invoice = mysqli_query($con, "SELECT * FROM payment WHERE tenantID='$userID' AND statusPayment='Paid'");
                    if (mysqli_num_rows($query_invoice)> 0) {
                      while ($row=mysqli_fetch_assoc($query_invoice)) {
                        $dueDate = $row['dueDate'];
                        $now = new DateTime($dueDate);
                          ...
                          <tr style="text-align:center">
                            ...
                            <td><?php echo $now->format('M 20y') ?></td>
                            <td>
                            ...
                            <td>
                            <a href="invoice-payment.php?paymentID=<?php echo $row['paymentID']; ?>" class="btn btn-secondary btn-md"><i class=" nav-icon fas fa-print"></i> Print Invoice</a>
                            </td>
                          </tr>
                          <?php
                        }
