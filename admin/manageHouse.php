  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="delete_house_image" class="btn btn-primary">Delete</button>
      </div>
      </form>
    </div>
  </div>
                      ...
                      <?php
                        ...
                        if (mysqli_num_rows($query_run) > 0) 
                        {
                         ...
                         <tr>
                          ...
                          <td>
                          <a href="addHouse.php?houseID=<?php echo $row['houseID']; ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                          </td>
                          <td> 
                          <form action="code.php" method="POST">
                            ...
                            <button type="submit" name="delete_house" class="btn btn-danger deletebtn" value="<?php echo $row['houseID']; ?>"><i class="nav-icon fas fa-trash-alt"></i></button>
                          </form> 
                          </td>
                      </tr>
                           <?php
