            ...
            <div class="col-12 m-auto">
              ...
              ?>
                <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                  ...
                  <input type="text" name="houseName" class="form-control" placeholder="">
                </div>
                  </div>
                  <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-control"  name="state" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                      <option selected disabled>choose</option>
                ...
                <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="number" name="noRoom" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">No of bathroom/toilet</label>
                      <input type="number" name="noToilet" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Type of floor</label>
                      <input type="text" name="floorType" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Availability of living room</label>
                      <input type="text" name="livingRoom" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Availability of air-conditioner</label>
                      <input type="number" name="airCond" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Availability of kitchen</label>
                      <input type="text" name="kitchen" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Type of kitchen</label>
                      <input type="text" name="typeKitchen" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Wifi-availability</label>
                      <input type="text" name="wifi" class="form-control" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Furniture</label>
                      <select class="form-control" name="furniture" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                      <option selected disabled>choose</option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gate" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                      <option selected disabled>choose</option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="cctv" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                      <option selected disabled>choose</option>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gateNguarded" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                      <option selected disabled>choose</option>
